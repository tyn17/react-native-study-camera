...
RCT_EXTERN_METHOD(getCachedFile:(NSString*)subFolder bodyPart:(NSNumber)bodyPart isThumb:(BOOL)isThumb resolver:(RCTPromiseResolveBlock)resolver rejecter:(RCTPromiseRejectBlock)rejecter)

RCT_EXTERN_METHOD(getCachedFilePath:(NSString*)subFolder bodyPart:(NSNumber)bodyPart isThumb:(BOOL)isThumb resolver:(RCTPromiseResolveBlock)resolver rejecter:(RCTPromiseRejectBlock)rejecter)
